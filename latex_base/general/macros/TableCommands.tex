...
\newcolumntype{C}{>{\PreserveBackslash\Centering\hspace{0pt}}X}
\newcolumntype{R}{>{\PreserveBackslash\RaggedLeft\hspace{0pt}}X}
\newcolumntype{L}{>{\PreserveBackslash\RaggedRight\hspace{0pt}}X}
